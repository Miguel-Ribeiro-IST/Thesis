...
x02=[0.2,-0.2,0.8,1,1,0.75];
lb2 = [0,-1,0,0,0,0];
ub2 = [5,1,5,100,100,1];

optimvars=Optimizer2(S0,B,r,x02,OptAlg,lb2,ub2);
alpha=optimvars(1);
rho0=optimvars(2);
nu02=optimvars(3);
a=optimvars(4);
...
Plotter(kappa,nubar,nu0,rho,chi,alpha,rho0,nu02,a,b,beta,S0,r,B,P,M,iterations,matur,SimPoints,OptAlg,lb,ub)
beep
...
function optimvars=Optimizer2(S0,B,r,x0,OptAlg,lb,ub)
...
%%%%%%%%%%%%%%%%%%%%%    PLOT OPTIMIZATION RESULTS    %%%%%%%%%%%%%%%%%%%%
function Plotter(kappa,nubar,nu0,rho,chi,alpha,rho0,nu02,a,b,beta,S0,r,B,P,M,iterations,matur,SimPoints,OptAlg,lb,ub)
figure
times=unique(B(:,1));
for iter=1:matur
    ...
    SABRVol=@(K)sigmaSABR(alpha,rho0,nu02,a,b,beta,K,S0*exp(r*T),T);
