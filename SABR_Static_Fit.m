...
matur=1;                  %maturity at which we want to fit the data. If matur=5, only the fifth maturity in the file is chosen.
...
Printer(alpha,rho,nu,beta,B,S0,r,T)
...
function Printer(alpha,rho,nu,beta,B,S0,r,T)
format longG
MKTVols=B(:,3);
