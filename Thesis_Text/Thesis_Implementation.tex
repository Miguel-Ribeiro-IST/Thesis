...
In all of these models we need to generate two correlated normal variables, $Z_1(t)$ and $Z_2(t)$, say with a correlation of $\rho(t)$. This can be easily achieved with
