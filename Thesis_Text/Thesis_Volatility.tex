...
C(\sigma_{imp},S(t),t)-C_{\mathrm{mkt}}=0,
\end{equation}
\noindent where $C(\sigma_{imp},\cdot)$ corresponds to the result of eq.\eqref{callputBS} using $\sigma_{imp}$ as (implied) volatility and $C_{\mathrm{mkt}}$ to the price of the option observed in the market.
...
\begin{equation}
\begin{split}
\int_K^\infty(S'-K)\left(\frac{1}{2}\sigma^2\pdv{^2(S'^2p)}{S'^2}\right)dS'&=\frac{1}{2}\sigma^2(S'-K)\pdv{(S'^2p)}{S'}\bigg|_{S'=K}^\infty-\frac{1}{2}\sigma^2\int_K^\infty\left(\pdv{(S'^2p)}{S'}\right)dS'\\
&=\frac{1}{2}\sigma^2S'^2p\big|_{S'=K}^\infty=\frac{1}{2}\sigma^2K^2p\\
&=\frac{1}{2}e^{r(T-t)}\sigma^2K^2\pdv{^2C}{K^2},
\end{split}
\end{equation}
