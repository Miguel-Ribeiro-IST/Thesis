...
As for the stock price volatility, $\sigma$, we will explore it deeply in the next sections. For now, suffice it to say that it is a measure of the future stock price movement's uncertainty.
