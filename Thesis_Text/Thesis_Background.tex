...
European options are, by far, the most traded type of option. Not only are they extremely useful to investors, but also very simple to study and comparatively easy to price. For all these reasons, they have been the subject of much research and are deeply understood. Furthermore, because of their high availability, they are used for model calibration and testing.
...
American options are the second most traded type of option. They are use

\section{Exotic Options}
European and American options are, by far, the most traded type. There types should not be neglected, however, as they are very much used by many investors.
