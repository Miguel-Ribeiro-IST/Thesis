...
pdflatex %.tex | makeindex %.glo -s %.ist -t %.glg -o %.gls | makeindex %.nlo -s nomencl.ist -o %.nls | bibtex %.aux | pdflatex -synctex=1 -interaction=nonstopmode %.tex | pdflatex -synctex=1 -interaction=nonstopmode %.tex
